...
public class UizaSurfaceActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedState) {
        ...
        String endpoint = getIntent().getStringExtra(SampleLiveApplication.EXTRA_STREAM_ENDPOINT);
        if (endpoint != null) {
    ...
    public void onConnectionSuccessRtmp() {
        runOnUiThread(() -> Toast.makeText(UizaSurfaceActivity.this, "Connection success", Toast.LENGTH_SHORT)
                .show());
    }
    ...
    public void onDisconnectRtmp() {
        runOnUiThread(() -> Toast.makeText(UizaSurfaceActivity.this, "Disconnected", Toast.LENGTH_SHORT).show());
    }

    @Override
    public void onAuthErrorRtmp() {
        runOnUiThread(() -> Toast.makeText(UizaSurfaceActivity.this, "Auth error", Toast.LENGTH_SHORT).show());
    }

    @Override
    public void onAuthSuccessRtmp() {
        runOnUiThread(() -> Toast.makeText(UizaSurfaceActivity.this, "Auth success", Toast.LENGTH_SHORT).show());
    }
