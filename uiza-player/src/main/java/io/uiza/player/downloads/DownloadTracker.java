package io.uiza.player.downloads;
...
public class DownloadTracker {
    ...
    Class<? extends DownloadService> serviceClazz;

    @Nullable
    private StartDownloadDialogHelper startDownloadDialogHelper;

    public DownloadTracker(Class<? extends DownloadService> clazz,
                           Context context, DataSource.Factory dataSourceFactory, DownloadManager downloadManager) {
        Assertions.checkState(clazz != null);
    ...
    public void toggleDownload(FragmentManager fragmentManager,
                               String name,
                               Uri uri,
                               String extension,
        ...
        if (download != null) {
            DownloadService.sendRemoveDownload(
                    context, serviceClazz, download.request.id, /* foreground= */ false);
        } else {
    ...
    private final class StartDownloadDialogHelper
        ...
        private void startDownload(DownloadRequest downloadRequest) {
            DownloadService.sendAddDownload(
                    context, serviceClazz, downloadRequest, /* foreground= */ false);
        }
